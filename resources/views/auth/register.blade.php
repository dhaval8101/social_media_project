                                ...
                                <div class="flex flex-col mb-3">
                                 ...
                                 <div class="flex flex-col mb-3">
                                    <input type="text" name="address" class="form-control" placeholder="Address" aria-label="Address">
                                     ...
                                     <div class="flex flex-col mb-3">
                                    <input type="number" name="phone" class="form-control" placeholder="Phone Number" aria-label="Phone">
                                </div>
                                     <div class="flex flex-col mb-3">
                                    <input type="text" name="city" class="form-control" placeholder="city" aria-label="City">
                                </div>
                                      <div class="flex flex-col mb-3">
                                    <input type="number" name="pin_code" class="form-control" placeholder="pin code" aria-label="Pin_code">
                                </div>
