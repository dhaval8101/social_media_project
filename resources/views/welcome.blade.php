...
<a class="like-button" href="{{ url('is-like/'. $post->id.'/' .$comment->id) }}">
    <button type="button" class="btn btn-link">
        <i class="fa fa-thumbs-up like-icon{{ $comment->likes && $comment->likes->where('user_id', Auth::id())->where('like', true)->count() > 0 ? ' active' : '' }}" style="font-size:25px"></i>
...
<a class="dislike-button" href="{{ url('dis-like/'. $post->id.'/' .$comment->id) }}">
    <button type="button" class="btn btn-link">
        <i class="fa fa-thumbs-down dislike-icon{{ $comment->likes && $comment->likes->where('user_id', Auth::id())->where('dislike', false)->count() > 0 ? ' active' : '' }}" style="font-size:25px"></i>
        <span class="dislike-count">{{ $comment->likes ? $comment->likes->where('like', false)->count() : 0 }}</span>
    </button>
</a>
...
$(document).ready(function() {
    ...
    $('.like-button').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Toggle the color of the thumbs-up icon
                ...
                // Remove active class from all dislike icons
    ...
    $('.dislike-button').on('click', function(e) {
        ...
        // Send AJAX request to server to update dislike status
        $.ajax({
            url: url,
            type: 'GET',
            success: function(response) {
                // Toggle the color of the dislike icon
                ...
                // Remove active class from all like icons
